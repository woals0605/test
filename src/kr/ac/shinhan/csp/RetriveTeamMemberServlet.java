 ...
 public class RetriveTeamMemberServlet extends HttpServlet { 
 	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException 
 	 { 
 		...
 		resp.getWriter().println("<tr>" + session.getAttribute("id") +"님 환영합니다."+ "</tr>"); 
 		...
 		{ 
 			...
 			resp.getWriter().println("<td>" + "<a href =/deleteMemberServlet?key="+tm.getKey()+ ">"+"삭제" + "</td>"); 
 			resp.getWriter().println("</tr>"); 
 		} 
 		resp.getWriter().println("</table>");
 		resp.getWriter().println("<br><a href='index.html'>처음으로</a>");
 		resp.getWriter().println("</body>"); 
 		resp.getWriter().println("</html>"); 
 	 } 
